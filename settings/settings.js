...
(function () {
  ...
  const I18N = {
    en: {
      ...
      "channel.title": "Chat Channels",
      "channel.tab.feishu": "Feishu",
      ...
      "channel.saved": "Chat channel configuration saved.",
      "channel.status": "Connected: Feishu",
      "channel.restartHint": "Chat channel config saved. Restart gateway to apply.",
    ...
    zh: {
      ...
      "channel.save": "保存",
      "channel.saving": "保存中…",
      "channel.saved": "聊天频道配置已保存。",
      "channel.status": "已连接: 飞书",
      "channel.restartHint": "聊天频道配置已保存，重启 Gateway 生效。",
